...
/**
 * \file sb_def.h
 * \brief SecretBlaze defines for Spartan-3 Digilent Starter Board
...
static const char CPU_CHIP[]           = "FPGA-SPARTAN3";

/* CLOCK SETTINGS */
#define FREQ_CORE_HZ                   50000000   /* cclk - default is 50 MHz */
#define C_S_CLK_DIV                    2          /* sclk - default is 25 MHz */
#define M_C_CLK_DIV                    2          /* mclk - default is 100 MHz */

/* CACHE SETTINGS */
#define SB_ICACHE_BYTE_SIZE            0x00002000 /* default is 8 KB */
#define SB_DCACHE_BYTE_SIZE            0x00002000 /* default is 8 KB */
...
#define SB_DC_BASE_ADDRESS             0x10002000
...
/* MEMORY MAP */
#define CACHEABLE_MEMORY_BYTE_SIZE     (0x00100000) /* default is 1 MB */
