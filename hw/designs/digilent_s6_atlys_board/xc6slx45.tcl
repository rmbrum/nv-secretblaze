...
set top_hw $top_path/xc6slx45_top.vhd  
...
set soc_lib_files [ list                                        \
          ...
          $src_dir/soc_lib/dram/dram_top.vhd                    \
          $src_dir/soc_lib/dram/dram_slave_wb_bus.vhd           \
          $src_dir/soc_lib/dram/dram_pack.vhd                   \
          $src_dir/soc_lib/dram/mig/mig_37.vhd                  \
          $src_dir/soc_lib/dram/mig/memc3_infrastructure.vhd    \
          $src_dir/soc_lib/dram/mig/memc3_wrapper.vhd           \
          $src_dir/soc_lib/dram/mig/mcb_raw_wrapper.vhd         \
          $src_dir/soc_lib/dram/mig/mcb_soft_calibration.vhd    \
          $src_dir/soc_lib/dram/mig/mcb_soft_calibration_top.vhd \
          $src_dir/soc_lib/dram/mig/iodrp_mcb_controller.vhd    \
          $src_dir/soc_lib/dram/mig/iodrp_controller.vhd        \
          $top_path/soc.vhd                                     \
  ]
...
set tb_verilog [ list                                           \
          $tb_dir/ddr2_model_parameters_c3.vh                   \
          $tb_dir/ddr2_model_c3.v                               \
  ]
...
set fpga_pack           "CSG324"					
set fpga_speed          "-3"						

set constraint_file     $ucf_dir/xc6slx45.ucf			
set top_level_inst      be_xc6slx45_top
set top_level_entity    xc6slx45_top
...
proc sim {} {
  ...
  # verilog files
  foreach filename $tb_verilog {
    if { ! [file_exist $filename] } {
      close $f_id
      return false
    }
    puts "  verilog work $filename"
    puts $f_id "verilog work $filename"
  }  
